...
> {
  ...
  private _lastGetEntry: UnaryFunction<
    Observable<fromRoot.State>,
    Observable<fromModel.ModelGetState<T>>
  >;
  private _lastListEntry: UnaryFunction<
    Observable<fromRoot.State>,
    Observable<fromModel.ModelListState<T>>
  >;
  private _lastCreateEntry: UnaryFunction<
    Observable<fromRoot.State>,
    Observable<fromModel.ModelCreateState<T>>
  >;
  private _lastPatchEntry: UnaryFunction<
    Observable<fromRoot.State>,
    Observable<fromModel.ModelPatchState<T>>
  >;
  private _lastUpdateEntry: UnaryFunction<
    Observable<fromRoot.State>,
    Observable<fromModel.ModelUpdateState<T>>
  >;
  private _lastDeleteEntry: UnaryFunction<
    Observable<fromRoot.State>,
    Observable<fromModel.ModelDeleteState<T>>
  >;
  private _lastDeleteAllEntry: UnaryFunction<
    Observable<fromRoot.State>,
    Observable<fromModel.ModelDeleteAllState<T>>
  >;
  private _lastQueryEntry: UnaryFunction<
    Observable<fromRoot.State>,
    Observable<fromModel.ModelQueryState<T>>
  >;
