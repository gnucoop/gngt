...
var specFiles = Object.keys(window.__karma__.files).filter(isGngtSpecFile);
...
/** Runs the Angular Gngt specs in Karma. */
function runGngtSpecs() {
...
/** Whether the specified file is part of Angular Gngt. */
function isGngtSpecFile(path) {
